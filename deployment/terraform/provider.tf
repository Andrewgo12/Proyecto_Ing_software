# Terraform Provider Configuration for Sistema de Inventario PYMES
# Additional provider configurations and resources
...
resource "aws_security_group" "eks_cluster" {
  name_prefix = "${var.project_name}-eks-cluster-sg-${var.environment}"
...
resource "aws_security_group" "eks_nodes" {
  name_prefix = "${var.project_name}-eks-nodes-sg-${var.environment}"
  vpc_id      = aws_vpc.main.id
